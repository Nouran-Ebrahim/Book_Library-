            ...
            <div class="table_des" style="height: 15em; ">
                <table class="table table-bordered tb">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <th scope="row"><?php echo $dataa['number'] ?></th>
                                <td><?php echo $dataa['title'] ?></td>
                                <td><?php echo $dataa['auther'] ?></td>
                                <td><?php echo $dataa['edition'] ?></td>
                                <td><?php echo $dataa['submission'] ?></td>
                                <td><a href="edit.php?id= <?php echo $dataa['id']; ?>"> <button type="button">Edit</button></a></td>
                                <td><a href="delete.php?id= <?php echo $dataa['id']; ?>"> <button type="button">delete</button></a></td>
                            </tr>
                        <?php
                        }
                        ?>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="delete.php?id= <?php echo $data['id']; ?>"> <button type="button">delete</button></a></td>
                        </tr>
                    <?php
                    }
                    ?>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO books(`number`,`title`,`auther`,`edition`,`submission`) VALUES('$num','$title','$auther','$edion','$submission')";
    $conn->exec($sql);
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="admin.php">Hello <?php echo $_SESSION["name"] ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="add.php">Add Book</a>
                    </li>
                    <li class="nav-item">
    ...
    <form class="row g-3 fr" method="POST" style="background-color: white;">
        <div class="col-md-6">
            ...
            <input type="number" name="number" class="form-control" id="formGroupExampleInput" required>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="auther" required class="form-control" id="inputPassword4">
        </div>
        <div class="col-md-6">
            <label class="form-label">Edition</label>
            <input type="text" name="edion" required class="form-control">
        </div>
        <div class="col-md-6">
            <label class="form-label">Submission Date</label>
            <input type="number" name="submission" required class="form-control">
        </div>
        <div class="col-12">
            <button type="submit" class="btn btn-primary bt" style="background-color: rgba(33,37,41,1);">Add</button>
        </div>
    </form>
    <div class="footer">
